...
tf.flags.DEFINE_string("dir", "../data/yelp13res", "The directory of the dataset")
...
tf.flags.DEFINE_string("model", "DeepCoNN", "model to train")
# ==================================================
...
def train_step(u_batch, i_batch, uid, iid, reuid, reiid, y_batch, batch_num):
    ...
    return loss, accuracy, mae, u_a, i_a, fm
        ...
        with sess.as_default():
            ...
            if FLAGS.model == 'DeepCoNN':
                deep = NARRE.DeepCoNN(
                    ...
                    n_latent=32)
            elif FLAGS.model == 'DeepCoNNpp':
                deep = NARRE.DeepCoNNpp(
                    review_num_u=review_num_u,
                    review_num_i=review_num_i,
                    review_len_u=review_len_u,
                    review_len_i=review_len_i,
            ...
            for epoch in range(FLAGS.num_epochs):
                ...
                for batch_num in range(ll):
                    ...
                    t_loss, t_rmse, t_mae, u_a, i_a, fm = train_step(u_batch, i_batch, uid, iid, reuid, reiid, y_batch,
                                                             batch_num)
                    ...
                    if batch_num % 100 == 0 and batch_num > 1:
                        print("batch_num: " + str(batch_num) + " train loss " + str(t_loss))
