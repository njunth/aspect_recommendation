...
tf.flags.DEFINE_string("valid_data", "%s/valid.csv" % TPS_DIR, " Data for validation")
...
def load_data_and_labels(train_data, valid_data, user_review, item_review, user_rid, item_rid, stopwords):
    ...
    reid_user_train = [] # instance-> id->all_reviewed_item_id
    reid_item_train = []
    uid_train = []
    iid_train = []
    y_train = []
    u_text = {}  # u->text
    u_rid = {}  # u->all reviewed items id
    i_text = {}
    i_rid = {}
    i = 0
